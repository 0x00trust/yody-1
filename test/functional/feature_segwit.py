...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        unknown_address = [convert_btc_address_to_yody("mtKKyoHabkk6e4ppT7NaM7THqPUt7AzPrT"), convert_btc_address_to_yody("2NDP3jLWAFT8NDAiUa9qiE6oBt2awmMq7Dx")]
        ...
        unsolvable_address = [convert_btc_address_to_yody("mjoE3sSrb8ByYEvgnC3Aox86u1CHnfJA4V"), convert_btc_address_to_yody("2N7MGY19ti4KDMSzRfPAssP6Pxyuxoi6jLe"), script_to_p2sh(op1), script_to_p2sh(op0)]
