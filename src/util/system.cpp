...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Yody
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Yody
    // Mac: ~/Library/Application Support/Yody
    // Unix: ~/.yody
#ifdef WIN32
    // Windows
