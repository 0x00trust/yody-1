...
#include "genesis/yodyMainNetwork.cpp"
...
#include "genesis/test/yodyTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::yodyMainNetwork: return c_genesisInfoYodyMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::yodyTestNetwork: return c_genesisInfoYodyTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::yodyMainNetwork: return c_genesisStateRootYodyMainNetwork;
    case Network::yodyTestNetwork: return c_genesisStateRootYodyTestNetwork;
