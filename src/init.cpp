...
void DeleteBlockChainData()
{
    ...
    fs::remove_all(GetDataDir() / "stateYody");
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                fs::path yodyStateDir = GetDataDir() / "stateYody";
            ...
            try {
                ...
                globalSealEngine->setYodySchedule(yodyDGP.getGasSchedule(::ChainActive().Height() + (::ChainActive().Height()+1 >= chainparams.GetConsensus().QIP7Height ? 0 : 1) ));
