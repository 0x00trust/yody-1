...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000001e46d8dc5a925fafcbb"); // yody
        ...
        vSeeds.emplace_back("seed0.yody.cash"); // Yody mainnet
        vSeeds.emplace_back("seed1.yody.cash"); // Yody mainnet
        vSeeds.emplace_back("seed2.yody.cash"); // Yody mainnet
        vSeeds.emplace_back("sedd3.yody.cash"); // Yody mainnet
        ...
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x86, 0xAD, 0xE4};
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000781160195346477981"); // yody
        ...
        vSeeds.emplace_back("test0.yody.cash"); // Yody testnet

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,110);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x88, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x88, 0x94};
...
{
    return dev::eth::Network::yodyMainNetwork;
}
