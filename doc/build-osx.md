...
1. Clone the Yody Core source code:
    ```shell
...
2.  Build Yody Core:
    ...
    Configure and build the headless Yody Core binaries as well as the GUI (if Qt is found).
...
## Running
Yody Core is now available at `./src/yodyd`
...
The first time you run yodyd, it will start downloading the blockchain. This process could
